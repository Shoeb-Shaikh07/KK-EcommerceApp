...
<html lang="en">
    <head>
        ...
        <title>Shoeb's E-Commerce</title>
        ...
        <section class="slider_area row m0">
            <div class="slider_inner">
                <div class="camera_caption">
                    <h2 class="wow fadeInUp animated">Start your day with Smile</h2>
        ...
        <section class="best_business_area row">
            ...
            <div class="row it_works">
              <?php
                        ...
                        $link = mysqli_connect('internal-app01db.mariadb.database.azure.com', 'ecomuser@internal-app01db', 'ecompassword', 'ecomdb');
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright 2023 Shoeb's Ecommerce | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
